...
#   --------------------------------------------
    ...
    do
      ...
      if [ $rcc -ne 0 ]; then
        ...
        echo " "
        set -x
        err_exit "tave.x- ERROR AT extrkr_gfs.sh LINE $LINENO"
      fi
...
#     300 to 900 mb, every 50 mb....
      ...
      if [ $rcc -ne 0 ]; then
        ...
        echo " "
        set -x
        err_exit "vint.x- ERROR for GPH AT extrkr_gfs.sh LINE $LINENO"
      fi
...
#     300 to 500 mb, every 50 mb....
      ...
      if [ $rcc -ne 0 ]; then
        ...
        echo " "
        set -x
        err_exit "vint.x- ERROR for T AT extrkr_gfs.sh LINE $LINENO"
      fi
