...
#     300 to 900 mb, every 50 mb....
      ...
      if [ $rcc -ne 0 ]; then
        ...
        echo " "
        set -x
        err_exit "gfdl_vint.x- ERROR for GPH AT extrkr_g2.sh LINE $LINENO"
      fi
...
#     300 to 500 mb, every 50 mb....
      ...
      if [ $rcc -ne 0 ]; then
        ...
        echo " "
        set -x
        err_exit "gfdl_vint.x- ERROR for T AT extrkr_g2.sh LINE $LINENO"
      fi
...
#     interpolated to get the mean 300-500 mb temperature...
      ...
      if [ $rcc -ne 0 ]; then
        ...
        echo " "
        set -x
        err_exit "gfdl_tave.x- ERROR AT extrkr_g2.sh LINE $LINENO"
      fi
